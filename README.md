...
- Extension icon shows a small top-right status dot: yellow while queued/downloading, green when all downloads complete.
...
4. Extension icon shows one top-right status dot for all downloads combined.
